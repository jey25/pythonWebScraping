...
def add_to_dict(di, word=None, definition=None):
  if type(di) != dict:
    print(f"You need to send a dictionary. You sent: {type(di)}")
  elif definition == None or word == None:
